(function( $ ){
	...
	var methods = {
		...
		init : function( options ){
					...
					$('body').append('<a class="ow-modal-close">CLOSE</a>');
					var speed_link = "<span class='ow-speed-picker'> <a>300</a> <a>400</a> <a>500</a> </span>";
					
					this.each(function(i){	
					$(this).addClass('ow-obj'+i);
					$(this).after('<a href="#" class="oneword-btn oneword' + i + '">Read in One Word</a>' + speed_link);
					$('.oneword' + i).click(function(e){
						...
						menu.children('a').click(function(e){
							...
							$('.ow-modal-close').show();
							var curr = 1;
							$('.ow-white-out, .ow-modal-close').click(function(){
